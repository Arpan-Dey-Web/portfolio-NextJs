          ...
          <div className="max-w-7xl mx-auto w-11/12 py-4">
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg bg-gradient-to-r from-[#DE2A8A] to-[#FF3D9A] text-white font-medium hover:shadow-lg hover:shadow-pink-500/50 transition-all duration-300"
              >
